...
<head>
    ...
    <title>Diamonds Guest House - York - Yorkshire</title>
        ...
        <div class="container">
            <div class="row py-4 fs-5">
                <div class=" col-md-3 mb-3 ">
                    ...
                    <p class="text-light d-block mt-3">Diamonds Guest House , 114 Bishopthorpe Road, York, North Yorkshire, YO23 1JX, United Kingdom .</p>
                ...
                <div class=" col-md-3 mb-3">
                    ...
                    <p class="mb-1 darkerGrotesque-semibold d-flex align-items-center text-light"><iconify-icon
                            class=" pe-2" icon="ic:baseline-local-phone"></iconify-icon>  +447340631122</p>
                    <p class="mb-1 darkerGrotesque-semibold d-flex align-items-center text-light"><iconify-icon
                            class=" pe-2" icon="tabler:brand-whatsapp"></iconify-icon> +447340631122 </p>
                    <p class="mb-1 darkerGrotesque-semibold d-flex align-items-center text-light"><iconify-icon
                            class=" pe-2" icon="ic:outline-email"></iconify-icon>diamondsguesthouse@gmail.com</p>
                </div>
                <div class=" col-md-3 mb-3">
            ...
            <div class="row pb-4">
                <div class="col-md-12 text-center">
                    ...
                    <span> &copy; Copyright@ 2016 Diamondsguesthosue all right reserved | Design and Developed by &nbsp;</span>
                    <a href="http://www.mentosoftware.co.uk/" target="_blank" rel="lightbox noopener noreferrer" style="color: rgb(255, 255, 255); text-decoration: none; background-color: rgb(255, 102, 51); font-family: ourfont-light; font-variant-ligatures: normal; letter-spacing: 1px; orphans: 2; text-align: center; widows: 2;">Mento Software</a> 
                </div>
            </div>
        </div>
    </footer>
